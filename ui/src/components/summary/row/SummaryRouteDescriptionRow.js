...
import SummaryRouteTitleRow from "./SummaryRouteTitleRow";
        ...
        <List.Item.Meta
            ...
            description={
                <div>
                    ...
                    <Typography.Text>환승 {item.info.busTransitCount + item.info.subwayTransitCount}회, </Typography.Text>
                    <Typography.Text>버스정류장 {item.info.busStationCount}개 +지하철역 {item.info.subwayStationCount}개</Typography.Text>
                </div>
            }
        />
    )
