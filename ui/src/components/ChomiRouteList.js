...
class ChomiRouteList extends Component {
    constructor(props) {
        super(props);
...
*/}
                <div>
                    <div className="search_input">
                        ...
                        />
                        <Button className="icon_rotate_90" icon="more" size="large"/>
                    </div>
                    <div className="search_input">
                        <Input.Search
                            size="large"
                            ...
                            onSearch={value => console.log(value)}
                        />
                        <Button className="icon_rotate_90" icon="swap" size="large"/>
                    </div>
                </div>
                {
...
*/}
                                    ...
                                    <Typography.Text
                                        type="danger">{route.path[routeIndex].info.totalTime}</Typography.Text>
                                    <Typography.Text>분,&nbsp;&nbsp;&nbsp;</Typography.Text>
                                    <Typography.Text
                                        type="warning">{route.path[routeIndex].info.payment}</Typography.Text>
